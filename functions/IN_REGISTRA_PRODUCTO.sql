    ...
    CREATE OR REPLACE FUNCTION IN_REGISTRA_PRODUCTO (    
        ...
        ELSE
            ...
            IF v_valRep > 0 THEN
                --
                OPEN c_prodRepeDska;
                FETCH c_prodRepeDska INTO v_dska_dska;
                CLOSE c_prodRepeDska;
                --
        ...
        ;
        --
        v_valida := cambio_nombre_prod_dska(v_dska_dska);        
        --
        RETURN 'OK-'||v_dska_dska;
        --
