...
$BODY$
    ...
    --
        ...
        --
            ...
            --
                INSERT INTO US_TCLIEN  (clien_clien,clien_cedula,clien_nombres,clien_apellidos,clien_telefono,clien_direccion)
                               VALUES ((SELECT COALESCE(MAX(clien_clien), 0) + 1 FROM us_tclien),datos.tmpclien_nit,datos.tmpclien_nombre,
