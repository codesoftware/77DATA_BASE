...
KAPR_COST_MVTO_UNI       NUMERIC(1000,10)        NOT NULL                 ,
KAPR_COST_MVTO_TOT       NUMERIC(1000,10)        NOT NULL                 ,
KAPR_COST_SALDO_UNI      NUMERIC(1000,10)        NOT NULL                 ,
KAPR_COST_SALDO_TOT      NUMERIC(1000,10)        NOT NULL                 ,
