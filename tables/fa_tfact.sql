...
CREATE TABLE FA_TFACT(
    ...
    FACT_VLR_TOTAL           NUMERIC(1000,6)        NOT NULL                    ,
    FACT_VLR_IVA             NUMERIC(1000,6)        NOT NULL                    ,
    ...
    FACT_VLR_DCTO            NUMERIC(1000,6)        NOT NULL   DEFAULT  0       ,
    FACT_VLR_EFECTIVO        NUMERIC(1000,6)        NOT NULL   DEFAULT  0       ,
    FACT_VLR_TARJETA         NUMERIC(1000,6)        NOT NULL   DEFAULT  0       ,
    FACT_CIERRE              BIGINT                                             ,
