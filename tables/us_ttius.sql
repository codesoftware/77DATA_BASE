...
TIUS_TIUS                BIGSERIAL                                    , -- Identificador primario de la tabla
TIUS_PERS                INT              NOT NULL                 , -- Llave foranea que se une con la tabla us_tpers
TIUS_PERF                INT              NOT NULL                 , -- 
TIUS_TIPO_USUARIO        VARCHAR(500)      NOT NULL                 , -- Indica el tipo de usuario de que tiene dentro del sistema (C)Cajero (A) Administrador 
TIUS_USUARIO             VARCHAR(500)      NOT NULL                 , -- Usuario con el cual ingresa al sistema (Unique)
...
TIUS_CONTRA_ACT          VARCHAR(500)                               , -- Contraseña activa con la cual ingresa al sistema
TIUS_CONTRA_FUTURA       VARCHAR(500)                               , -- Contraseña con la cual podra entrar al sistema
