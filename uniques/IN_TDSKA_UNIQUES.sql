...
UNIQUE (DSKA_MARCA, DSKA_REFE, DSKA_CATE,DSKA_DESC)
;
--
--Evita que el codigo externo se repita en el sistema
--
ALTER TABLE IN_TDSKA
ADD CONSTRAINT DSKA_COD_EXT_UNIQUE UNIQUE (DSKA_COD_EXT)
;