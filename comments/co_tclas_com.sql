...
COMMENT ON COLUMN   CO_TCLAS.CLAS_CODIGO        IS     'Codigo con el cual los contadores identifican que clase es';
COMMENT ON COLUMN   CO_TCLAS.CLAS_DESCRIPCION   IS     'Descripcion de la informacion que tendra esta cuenta';
COMMENT ON COLUMN   CO_TCLAS.CLAS_NATURALEZA    IS     'Indica si la cuenta es de debito(D) o credito(C) ';