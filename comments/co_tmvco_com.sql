...
COMMENT ON COLUMN   CO_TMVCO.MVCO_LLADETALLE        IS     'Identificador con el cual se sabe si genero un movimiento de inventario o una factura etc.(pgrm) Pago de una remision, importacion(impo), gasto importacion(gaimp) ';
