COMMENT ON TABLE   	co_tauco                    IS     'Tabla encargada de almacenar los auxiliares contables de la cuentas';
COMMENT ON COLUMN   co_tauco.AUCO_AUCO          IS     'Identificador primario de la tabla';
COMMENT ON COLUMN   co_tauco.AUCO_SBCU          IS     'Subcuenta con el cual esta asociado';
